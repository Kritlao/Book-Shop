...
/**
 * Created by iMac_19 on 6/21/2016 AD.
 */
public class BookDapter extends BaseAdapter {

    //Expicit
    private Context context;
    private String[] iconStrings,nameStrings, priceStrings;

    public BookDapter(Context context, String[] iconStrings, String[] nameStrings, String[] priceStrings) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TextView nametextView = (ImageView).vi
